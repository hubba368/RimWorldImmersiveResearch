...
namespace ImmersiveResearch
{
    public class ITab_Experiments : ITab_Bills
    {
        ...
        protected Building_ExperimentBench SelectedTable => (Building_ExperimentBench)base.SelThing;
        ...
        protected override void FillTab()
        {
            ...
            _mouseoverBill = SelectedTable.ExpStack.DoListing(rect1, SelectedTable, ref _scrollPosition, ref _viewHeight);
        }
